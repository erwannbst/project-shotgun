...
export function ProjectItem(props: ProjectProps) {
  ...
  return (
    <div className="h-full relative min-w-80 border-slate-200 border">
      {projectIsOwned && (
        <div className="flex z-50 absolute inset-0 bg-green-100/60 text-green-200 font-bold p-1 text-center items-center justify-center self-center backdrop-brightness-150">
          <svg
            width="150"
            height="150"
            viewBox="0 0 15 15"
